...
const AboutSection = () => {
  ...
  return (
    <section id='#nosotros' className='text-gray-400 flex flex-col'>
      <div className='px-5 md:px-0 py-20 max-w-3xl mx-auto text-center border-b border-primary-500/10'>
        <h2 className='mb-10 text-primary-500 text-4xl tracking-widest'>NOSOTROS</h2>
        <p className='text-xl font-light'>La mayor red de oficinas de Social Big Data a lo largo de Latinoamérica y España. <br />
      ...
      <div className='px-5 md:px-0 py-20 w-full max-w-3xl mx-auto text-center border-b border-primary-500/10'>
