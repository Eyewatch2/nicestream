    ...
    return (
        <section className='md:w-[calc(100svw-20px)] max-w-[100svw] overflow-hidden h-svh 2xl:h-[80svh] pt-[calc(2.5rem+5em)] relative bg-cover' style={{ backgroundImage: `url(/img/bg-home.jpg)` }}>
            <div className='max-w-screen-xl py-4 mx-auto flex flex-col gap-10 items-center justify-center h-[calc(100%-(2.5rem+5em))] md:h-auto md:items-stretch'>
                ...
                <Link id='CTA' className='w-fit z-30 relative linkAnimation 2xl:mt-16 2xl:text-3xl hover:text-primary-500 transition duration-500 border border-primary-500 rounded-full px-12 py-4 text-xl font-bold' href={"#contacto"}>
                    <span className='z-30 relative'>HABLEMOS</span>
                </Link>
            </div>
            <Link href={"#nosotros"}>
                <Image id='scrollIndicator' alt='scroll' unoptimized width={200} height={150} src="/img/scroll-indicator.gif" className='z-20 absolute hidden md:block bottom-0 right-1/2 translate-x-1/2 invert mix-blend-screen' />
            </Link>
